...
import { DetailedViewUseCase } from '../../src/usecases/detailed-view.usecase';
...
describe('Detailed view use case...', () => {
  beforeEach(() => {
  ...
  it('with movies, it returns an object with all data with the trailer added', async () => {
    TMDBRepository.mockImplementation(() => {
      return {
        getDetails: () => MOVIE_DETAIL,
        getVideos: () => MOVIE_VIDEOS
      };
    });
